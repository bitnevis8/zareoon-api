...
EscrowAgreement.init(
  {
    ...
    contractVersion: { type: DataTypes.STRING(64), allowNull: true },
    buyerSignedAt: { type: DataTypes.DATE, allowNull: true },
    sellerSignedAt: { type: DataTypes.DATE, allowNull: true },
    buyerSignIp: { type: DataTypes.STRING(64), allowNull: true },
    sellerSignIp: { type: DataTypes.STRING(64), allowNull: true },
